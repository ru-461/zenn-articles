...
回線速度を測定するたびに、毎回Webブラウザを開いてサイトにアクセスするのは少し手間に感じることがあります。
...
Fastを開かずとも、ターミナルから簡単に回線の速度を測れるのは便利です。

Discussionにて紹介していただいたのですが、同じようなツールとして[Speedtest CLI](https://www.speedtest.net/ja/apps/cli)があります。
こちらを導入したときのメモは[スクラップ](https://zenn.dev/ryuu/scraps/2d4e2592dbe45d)にまとめております。併せてご覧ください。
