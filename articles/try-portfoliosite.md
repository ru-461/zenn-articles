---
title: "Vue.jsでポートフォリオサイトを構築した話"
emoji: "🗨"
type: "tech" # tech: 技術記事 / idea: アイデア
topics: ["Vue", "初心者", "Vuetify", "ポートフォリオサイト"]
published: false
---
...
:::message
ポートフォリオサイトを作成し始めるタイミングでちょうどよく Vue3 がリリースされたのですが、書籍と Udemy の講座動画の内容に合わせるため、今回は `Vue2.x 系`を利用して制作しています。
:::
