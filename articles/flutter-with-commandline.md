...
Scoopはコマンドツール以外にもAndroid StudioやVSCodeようなGUIをもつアプリケーションも同じくインストールできます。しかし、Scoopでアプリケーションをインストールする場合、Windowsの想定するディレクトリ構成と異なるため不具合に繋がる可能性もあります、そのため私は現在GUIベースのアプリケーションをWindows Package Manager、CUIベースのツールをScoopと分けて管理しています。
