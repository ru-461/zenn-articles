---
title: "VSCode使いなら押さえておくべきCodeコマンド"
emoji: "🧩"
...
瞬間的にVSCodeが立ち上がり、ファイルやディレクトリが開かれるので、生産性が上がります。
...
ローカルのファイルを開くことはもちろん可能ですが、WSLであっても同じように使用できます。
VSCodeとWSL2の親和性が高いのでWindowsで開発するときに威力を発揮します。

## Codeコマンドの準備【macOS】

macOSの場合はシェルコマンドを手動で実行する必要があり、少し手間がかかります。
